...
It is used by the `stage` to compare the location of a given `.vbox` file - which is the configuration file of any given virtual machine and resides inside that machine's directory -  `getRunningVMs` Function
